...
Output::Output()
{
	...
	UI.GridLineColor = WHITE; //TO BE CHANGED TO WHITE
...
void Output::CreateDesignModeToolBar() const
{
	...
	MenuItemImages[ITM_COPY_CARD] = "images\\copy_icon.jpg";
	MenuItemImages[ITM_CUT_CARD] = "images\\cut_icon.jpg";
	MenuItemImages[ITM_PASTE_CARD] = "images\\paste_icon.jpg";
	MenuItemImages[ITM_DELETE_GAME_OBJECT] = "images\\delete_icon.jpg";
	MenuItemImages[ITM_SAVE_GRID] = "images\\save_icon.jpg";
	MenuItemImages[ITM_OPEN_GRID] = "images\\open_icon.jpg";
...
void Output::CreatePlayModeToolBar() const
{
	...
	MenuItemImages[ITM_INPUT_DICE_VALUE] = "images\\input_dice_value_icon.jpg";
...
void Output::DrawLadder(const CellPosition & fromCell, const CellPosition & toCell) const
{
	...
	{
		pWind->DrawLine(x12, toStartY + UI.CellHeight * j, x34, toStartY + UI.CellHeight * j);
		j++;
	}
...
void Output::DrawSnake(const CellPosition & fromCell, const CellPosition & toCell) const
{
	...
	int xarr[] = { x12,x12 + xChange,x12,x12 - xChange };
	int yarr[] = { y1-yChange,y1,y1 + yChange,y1 };
